...
public class XmlStubRequestTest {

    private static final StubContentType CONTENT_TYPE = new StubContentType(APPLICATION_XML);

    private Object body;
    private StubRequest<Object, XmlStubRequest> request;

    @Before
    public void setUp() {
        body = someThing();
        request = new XmlStubRequest<>(body);
    }
    ...
    @Test
    public void Can_copy_a_XML_request() {
        ...
        // When
        final XmlStubRequest actual = request.copy();
