...
public class ITJsonStubIgnoreFields {
    ...
    @Test
    public void Can_ignore_fields_in_a_stubbed_JSON_request() {
        ...
        final TestResponse actual = client.target(stubUrl.toString()).request(APPLICATION_JSON_TYPE)
            .post(json(new TestObject(one, new TestChild(someInteger()))), TestResponse.class);
