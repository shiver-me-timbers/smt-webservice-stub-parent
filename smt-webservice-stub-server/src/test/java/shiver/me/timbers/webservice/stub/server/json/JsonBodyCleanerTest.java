...
public class JsonBodyCleanerTest {

    private JsonBodyCleaner cleaner;

    @Before
    public void setUp() {
        cleaner = new JsonBodyCleaner(mock(ObjectMapper.class), mock(MapKeyFilter.class));
    }
    ...
    public void Can_support_JSON_requests() {
        ...
        // Given
        given(contentType.isJson()).willReturn(expected);
